/**
 * Converts ISO 3166-1 alpha-2 country codes to alpha-3 codes
 * Used for Dollr API which requires 3-letter country codes
 */
...
export function convertCountryCodeToAlpha3(alpha2Code: string): string {
  return ALPHA2_TO_ALPHA3[alpha2Code] || alpha2Code
}
