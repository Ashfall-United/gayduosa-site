...
import { ORG_EMAIL, ORG_FACEBOOK, ORG_INSTAGRAM, ORG_LINKEDIN, ORG_NAME, ORG_SHORT, ORG_WEBMAIL } from '@/lib/constants'
...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Ashfall United', href: 'https://www.ashfallunited.com', external: true },
    ],
  },
] as const
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-10 py-12 sm:py-16">
          <div className="grid grid-cols-2 lg:grid-cols-[2fr_1fr_1fr] gap-8 sm:gap-10">
            ...
            <div className="col-span-2 lg:col-span-1">
              <Link href="/" aria-label={`${ORG_NAME} home`} className="inline-flex items-center mb-5">
              ...
              <p className="text-white/50 text-xs sm:text-sm leading-relaxed max-w-xs mb-6">
                A social enterprise using the power of sport to unlock opportunity for young people
                in Monrovia, Liberia.
              </p>

              <a
                href={`mailto:${ORG_EMAIL}`}
                className="block text-[#fee11b] text-xs sm:text-sm hover:text-white transition-colors mb-6"
              >
                {ORG_EMAIL}
              </a>
              ...
              <div className="flex gap-2">
                {socials.map((s) => (
                  <a
                    ...
                    aria-label={s.label}
                    className="w-9 h-9 border border-white/15 hover:border-[#fee11b] hover:bg-[#fee11b] text-white/60 hover:text-[#01255f] flex items-center justify-center transition-all duration-300"
                  >
                    {s.icon}
                  </a>
                ))}
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-10 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p className="text-white/30 text-[11px] sm:text-xs text-center sm:text-left">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="ml-3 font-bold text-[#fee11b]/70 hover:text-[#fee11b] transition-colors"
          >
            Webmail
          </a>
        </p>
